...
public class Modelgoblin_scout<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "goblin_scout"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Torsohead.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(48, 56).addBox(-13.5F, -28.0F, 11.0F, 8.0F, 8.0F, 0.0F,
		...
		PartDefinition cube_r2 = Torsohead.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(55, 6)
						.addBox(-2.75F, -12.4454F, -2.75F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(55, 0)
						.addBox(-2.25F, -12.4454F, -3.25F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(51, 0)
						.addBox(-0.8F, -2.4454F, -1.8206F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(51, 5)
						.addBox(0.35F, -2.4454F, -1.15F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Torsohead.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(47, 0)
						.addBox(-4.0F, -28.0F, 11.0F, 1.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(23, 53)
						.addBox(-3.0F, -19.0F, 10.0F, 5.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Head.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(51, 3)
						...
						.addBox(-6.3149F, 0.2167F, -9.3F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(51, 15)
						.addBox(-7.3149F, 0.2167F, -9.3F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(51, 21)
		...
		PartDefinition cube_r8 = Ears.addOrReplaceChild("cube_r8",
		...
		PartDefinition cube_r9 = Ears.addOrReplaceChild("cube_r9",
		...
		PartDefinition cube_r10 = Ears2.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 11).addBox(-17.0F, 0.9F, 1.0F, 3.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, -11.1625F, 0.6109F, 0.0F, -0.0436F));

		PartDefinition cube_r11 = Ears2.addOrReplaceChild("cube_r11",
		...
		PartDefinition cube_r23 = bone10
		...
		PartDefinition cube_r24 = Tail.addOrReplaceChild("cube_r24",
		...
		PartDefinition cube_r26 = bone1.addOrReplaceChild("cube_r26",
		...
		PartDefinition cube_r27 = bone2.addOrReplaceChild("cube_r27",
