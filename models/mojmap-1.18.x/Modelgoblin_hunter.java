...
public class Modelgoblin_hunter<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "goblin_hunter"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = Torsohead.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(23, 55).addBox(-4.0F, 0.3F, -0.95F, 9.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-15.0F, -15.0F, -1.0F, 0.6981F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Torsohead.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(23, 62).addBox(-5.0F, 0.275F, -0.775F, 9.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-14.0F, -9.0F, 3.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r4 = Torsohead.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(23, 57)
						.addBox(-8.0F, -15.0F, 9.25F, 9.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-8.0F, -17.0F, 4.0F, 9.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-11.0F, 5.0F, 0.0F, 0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Torsohead.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(6, 49).addBox(-0.75F, -2.25F, -0.4F, 3.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-14.0F, -5.0F, 0.0F, -0.8727F, 0.2618F, 0.0F));

		PartDefinition cube_r6 = Torsohead.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(6, 49).addBox(-3.0F, -2.25F, -0.4F, 3.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-14.0F, -5.0F, 0.0F, -0.8727F, -0.2618F, 0.0F));

		PartDefinition cube_r7 = Torsohead.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(-4, 49).mirror()
						.addBox(-5.8435F, -3.0F, -2.4F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-14.0F, -5.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition cube_r8 = Torsohead.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(-4, 49).addBox(1.1565F, -2.351F, -2.4F, 4.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-14.0F, -5.0F, 0.0F, 0.0F, 0.0F, 0.6109F));
		...
		PartDefinition cube_r9 = Head.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(51, 3)
						.addBox(-5.3149F, 0.2167F, -9.3F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(51, 9)
						.addBox(-6.3149F, 0.2167F, -9.3F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(51, 3)
						.addBox(-7.3149F, 0.2167F, -9.3F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(51, 9)
						.addBox(-8.3149F, 0.2167F, -9.3F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Ears.addOrReplaceChild("cube_r11",
		...
		PartDefinition cube_r12 = Ears.addOrReplaceChild("cube_r12",
		...
		PartDefinition cube_r13 = Ears2.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 11).addBox(-17.0F, 0.9F, 1.0F, 3.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, -11.1625F, 0.6109F, 0.0F, -0.0436F));

		PartDefinition cube_r14 = Ears2.addOrReplaceChild("cube_r14",
		...
		PartDefinition cube_r15 = RightArm.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(42, 54)
						.addBox(-11.2F, -3.15F, -4.9F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 56)
						.addBox(-11.69F, -3.15F, -4.9F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.001F)).texOffs(38, 6)
						.addBox(-11.7F, -10.8F, -4.9F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = LeftArm.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(42, 58)
						.addBox(11.25F, -2.15F, -4.558F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 60)
						.addBox(11.69F, -2.15F, -4.558F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(25, 37)
						.addBox(9.7F, -9.8603F, -4.558F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = bone4.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(50, 40)
						.addBox(-2.8F, -3.1F, -1.65F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 33)
						.addBox(-2.8F, -3.1F, -0.9F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 40)
						.addBox(-2.8F, -3.1F, -0.15F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 33)
						.addBox(-2.8F, -3.1F, 0.6F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = bone7.addOrReplaceChild("cube_r22",
		...
		PartDefinition cube_r25 = bone6.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(50, 33)
						.addBox(-5.65F, -1.15F, 1.75F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 33)
						.addBox(-5.65F, -1.15F, 3.25F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 40)
						.addBox(-5.65F, -1.15F, 2.5F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 40)
						.addBox(-5.65F, -1.15F, 4.0F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = bone8.addOrReplaceChild("cube_r27",
		...
		PartDefinition cube_r28 = bone10
		...
		PartDefinition cube_r31 = bone1.addOrReplaceChild("cube_r31",
		...
		PartDefinition cube_r32 = bone2.addOrReplaceChild("cube_r32",
