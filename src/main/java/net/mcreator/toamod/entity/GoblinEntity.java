...
import net.mcreator.toamod.procedures.GoblinSpawnConditionProcedure;
import net.mcreator.toamod.procedures.GoblinInitialSpawnProcedure;
...
public class GoblinEntity extends Monster {
	public GoblinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ToamodModEntities.GOBLIN.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GoblinInitialSpawnProcedure.execute(this);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(ToamodModEntities.GOBLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return GoblinSpawnConditionProcedure.execute(world, x, y, z);
		});
	}
