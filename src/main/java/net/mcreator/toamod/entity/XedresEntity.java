...
public class XedresEntity extends Monster {
	public XedresEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ToamodModEntities.XEDRES.get(), world);
	}

	public XedresEntity(EntityType<XedresEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§4Boss§r"));
