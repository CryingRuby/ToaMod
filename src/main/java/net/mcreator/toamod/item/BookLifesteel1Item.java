...
import net.mcreator.toamod.procedures.BookLifesteel1CraftedProcedure;
import net.mcreator.toamod.init.ToamodModTabs;

import java.util.List;

public class BookLifesteel1Item extends Item {
	public BookLifesteel1Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Lifesteel I\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b75 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookLifesteel1CraftedProcedure.execute(itemstack);
	}
}
