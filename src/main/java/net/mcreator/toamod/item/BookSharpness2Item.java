...
import net.mcreator.toamod.procedures.BookSharpness2CraftedProcedure;

import java.util.List;

public class BookSharpness2Item extends Item {
	public BookSharpness2Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Sharpness II\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b20 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookSharpness2CraftedProcedure.execute(itemstack);
	}
}
