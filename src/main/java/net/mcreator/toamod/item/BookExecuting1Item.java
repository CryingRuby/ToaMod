...
import net.mcreator.toamod.procedures.BookExecuting1CraftedProcedure;

import java.util.List;

public class BookExecuting1Item extends Item {
	public BookExecuting1Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Executing I\u00A7r"));
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookExecuting1CraftedProcedure.execute(itemstack);
	}
}
