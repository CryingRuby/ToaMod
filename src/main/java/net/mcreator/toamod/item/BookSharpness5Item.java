...
import net.mcreator.toamod.procedures.BookSharpness5CraftedProcedure;

import java.util.List;

public class BookSharpness5Item extends Item {
	public BookSharpness5Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Sharpness V\u00A7r"));
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookSharpness5CraftedProcedure.execute(itemstack);
	}
}
