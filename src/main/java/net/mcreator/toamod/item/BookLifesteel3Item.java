...
import net.mcreator.toamod.procedures.BookLifesteel3CraftedProcedure;

import java.util.List;

public class BookLifesteel3Item extends Item {
	public BookLifesteel3Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b225 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookLifesteel3CraftedProcedure.execute(itemstack);
	}
}
