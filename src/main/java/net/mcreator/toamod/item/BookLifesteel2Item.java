...
import net.mcreator.toamod.procedures.BookLifesteel2CraftedProcedure;

import java.util.List;

public class BookLifesteel2Item extends Item {
	public BookLifesteel2Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Executing III\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b135 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookLifesteel2CraftedProcedure.execute(itemstack);
	}
}
