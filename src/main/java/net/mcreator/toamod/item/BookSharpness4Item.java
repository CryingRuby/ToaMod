...
import net.mcreator.toamod.procedures.BookSharpness4CraftedProcedure;
import net.mcreator.toamod.init.ToamodModTabs;

import java.util.List;

public class BookSharpness4Item extends Item {
	public BookSharpness4Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Sharpness IV\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b55 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookSharpness4CraftedProcedure.execute(itemstack);
	}
}
