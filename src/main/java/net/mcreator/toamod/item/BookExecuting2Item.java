...
import net.mcreator.toamod.procedures.BookExecuting2CraftedProcedure;

import java.util.List;

public class BookExecuting2Item extends Item {
	public BookExecuting2Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Executing II\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b80 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookExecuting2CraftedProcedure.execute(itemstack);
	}
}
