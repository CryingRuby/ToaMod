...
public class ScrollWeaknessItem extends Item {
	public ScrollWeaknessItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A76Ability: \u00A77Reduces nearby enemies damage for 5s by 2 (30s Cooldown)\u00A7r"));
	}
}
