...
import net.mcreator.toamod.item.inventory.PlayerRecipesItemInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class PlayerRecipesItemItem extends Item {
	public PlayerRecipesItemItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Player Recipes Item");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new PlayerRecipesItemInventoryMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new PlayerRecipesItemInventoryCapability();
	}
