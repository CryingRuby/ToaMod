...
import net.mcreator.toamod.procedures.BookSharpness3CraftedProcedure;
import net.mcreator.toamod.init.ToamodModTabs;

import java.util.List;

public class BookSharpness3Item extends Item {
	public BookSharpness3Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Sharpness III\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b35 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookSharpness3CraftedProcedure.execute(itemstack);
	}
}
