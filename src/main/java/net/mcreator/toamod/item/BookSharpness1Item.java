...
import net.mcreator.toamod.procedures.BookSharpness1CraftedProcedure;

import java.util.List;

public class BookSharpness1Item extends Item {
	public BookSharpness1Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Sharpness I\u00A7r"));
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b10 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookSharpness1CraftedProcedure.execute(itemstack);
	}
}
