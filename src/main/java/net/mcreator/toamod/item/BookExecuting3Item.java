...
import net.mcreator.toamod.procedures.BookExecuting3CraftedProcedure;
import net.mcreator.toamod.init.ToamodModTabs;

import java.util.List;

public class BookExecuting3Item extends Item {
	public BookExecuting3Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77Right Click to activate enchantment with \u00A7b110 magic dust\u00A77.\u00A7r"));
	}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		BookExecuting3CraftedProcedure.execute(itemstack);
	}
}
