...
public class ArmoryTableGuiScreen extends AbstractContainerScreen<ArmoryTableGuiMenu> {
	private final static HashMap<String, Object> guistate = ArmoryTableGuiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ArmoryTableGuiScreen(ArmoryTableGuiMenu container, Inventory inventory, Component text) {
