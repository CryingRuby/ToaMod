...
public class WeaponTableGuiScreen extends AbstractContainerScreen<WeaponTableGuiMenu> {
	private final static HashMap<String, Object> guistate = WeaponTableGuiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public WeaponTableGuiScreen(WeaponTableGuiMenu container, Inventory inventory, Component text) {
