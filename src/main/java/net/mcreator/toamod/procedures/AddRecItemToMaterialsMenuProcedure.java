...
public class AddRecItemToMaterialsMenuProcedure {
	public static void execute(Entity entity) {
		...
		for (int index0 = 0; index0 < 75; index0++) {
			...
			}.getItemStack((int) i, ((entity.getCapability(ToamodModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ToamodModVariables.PlayerVariables())).plyRecMaterials))).getItem() == Blocks.GRAY_STAINED_GLASS_PANE.asItem()) {
				{
