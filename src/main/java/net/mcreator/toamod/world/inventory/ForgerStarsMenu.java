...
public class ForgerStarsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ForgerStarsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.FORGER_STARS.get(), id);
