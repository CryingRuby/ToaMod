...
import net.mcreator.toamod.procedures.OnArtefactsMenuTickProcedure;
import net.mcreator.toamod.network.ArtefactsMenuSlotMessage;
...
public class ArtefactsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ArtefactsMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.ARTEFACTS_MENU.get(), id);
		...
		this.customSlots.put(27, this.addSlot(new SlotItemHandler(internal, 27, 79, 67) {
			...
			public void onQuickCraft(ItemStack a, ItemStack b) {
				super.onQuickCraft(a, b);
				slotChanged(27, 2, b.getCount() - a.getCount());
			}
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new ArtefactsMenuSlotMessage(slotid, x, y, z, ctype, meta));
			ArtefactsMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof ArtefactsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnArtefactsMenuTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
