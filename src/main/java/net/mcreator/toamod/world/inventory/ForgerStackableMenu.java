...
public class ForgerStackableMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ForgerStackableMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.FORGER_STACKABLE.get(), id);
