...
import net.mcreator.toamod.procedures.OnFighterRewardsTickProcedure;
import net.mcreator.toamod.network.FighterMilestoneRewardsMenuSlotMessage;
...
public class FighterMilestoneRewardsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FighterMilestoneRewardsMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.FIGHTER_MILESTONE_REWARDS_MENU.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new FighterMilestoneRewardsMenuSlotMessage(slotid, x, y, z, ctype, meta));
			FighterMilestoneRewardsMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof FighterMilestoneRewardsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnFighterRewardsTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
