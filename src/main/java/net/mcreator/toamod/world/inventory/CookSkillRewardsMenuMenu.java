...
import net.mcreator.toamod.procedures.OnCookSkillRewardsTickProcedure;
import net.mcreator.toamod.network.CookSkillRewardsMenuSlotMessage;
...
public class CookSkillRewardsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CookSkillRewardsMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.COOK_SKILL_REWARDS_MENU.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new CookSkillRewardsMenuSlotMessage(slotid, x, y, z, ctype, meta));
			CookSkillRewardsMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CookSkillRewardsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnCookSkillRewardsTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
