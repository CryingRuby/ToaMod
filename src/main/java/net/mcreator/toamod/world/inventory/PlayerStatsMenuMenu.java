...
import net.mcreator.toamod.procedures.OnPlayerStatsMenuTickProcedure;
...
public class PlayerStatsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof PlayerStatsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnPlayerStatsMenuTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
