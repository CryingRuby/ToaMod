...
import net.mcreator.toamod.procedures.OnComSkillRewardsTickProcedure;
import net.mcreator.toamod.network.ComSkillRewardsMenuSlotMessage;
...
public class ComSkillRewardsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ComSkillRewardsMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.COM_SKILL_REWARDS_MENU.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new ComSkillRewardsMenuSlotMessage(slotid, x, y, z, ctype, meta));
			ComSkillRewardsMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof ComSkillRewardsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnComSkillRewardsTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
