...
import net.mcreator.toamod.procedures.OnDwarfsWayRewardsTickProcedure;
import net.mcreator.toamod.network.DwarvesWayMilestoneRewardsMenuSlotMessage;
...
public class DwarvesWayMilestoneRewardsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DwarvesWayMilestoneRewardsMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.DWARVES_WAY_MILESTONE_REWARDS_MENU.get(), id);
		...
		this.customSlots.put(21, this.addSlot(new SlotItemHandler(internal, 21, 92, 96) {
			...
			public void onQuickCraft(ItemStack a, ItemStack b) {
				...
				slotChanged(21, 2, b.getCount() - a.getCount());
			}
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new DwarvesWayMilestoneRewardsMenuSlotMessage(slotid, x, y, z, ctype, meta));
			DwarvesWayMilestoneRewardsMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof DwarvesWayMilestoneRewardsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnDwarfsWayRewardsTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
