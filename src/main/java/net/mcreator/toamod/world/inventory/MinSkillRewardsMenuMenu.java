...
import net.mcreator.toamod.procedures.OnMinSkillRewardsTickProcedure;
import net.mcreator.toamod.network.MinSkillRewardsMenuSlotMessage;
...
public class MinSkillRewardsMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MinSkillRewardsMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.MIN_SKILL_REWARDS_MENU.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new MinSkillRewardsMenuSlotMessage(slotid, x, y, z, ctype, meta));
			MinSkillRewardsMenuSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof MinSkillRewardsMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnMinSkillRewardsTickProcedure.execute(world, x, y, z, entity);
		}
	}
}
