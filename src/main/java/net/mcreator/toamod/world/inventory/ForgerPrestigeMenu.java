...
public class ForgerPrestigeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ForgerPrestigeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.FORGER_PRESTIGE.get(), id);
