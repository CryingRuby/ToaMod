...
import net.mcreator.toamod.procedures.OnForgerGuiTickProcedure;
import net.mcreator.toamod.procedures.OnForgerGuiClosedProcedure;
...
public class ForgerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ForgerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 30, 22) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 166, 14) {
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 166, 38) {
		...
		for (int si = 0; si < 3; ++si)
			for (int sj = 0; sj < 9; ++sj)
				this.addSlot(new Slot(inv, sj + (si + 1) * 9, 19 + 8 + sj * 18, 26 + 84 + si * 18));
		for (int si = 0; si < 9; ++si)
			this.addSlot(new Slot(inv, si, 19 + 8 + si * 18, 26 + 142));
		OnForgerGuiClosedProcedure.execute(world, entity);
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof ForgerGuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			OnForgerGuiTickProcedure.execute(world, entity);
		}
	}
}
