...
public class EnhancementTableGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnhancementTableGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ToamodModMenus.ENHANCEMENT_TABLE_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 131, 33) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 23, 33) {
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 77, 33) {
		...
		OnEnhancementTableGuiClosedProcedure.execute(world, entity);
	}
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			ToamodMod.PACKET_HANDLER.sendToServer(new EnhancementTableGuiSlotMessage(slotid, x, y, z, ctype, meta));
			EnhancementTableGuiSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
