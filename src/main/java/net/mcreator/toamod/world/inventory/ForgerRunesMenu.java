...
public class ForgerRunesMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ForgerRunesMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 116, 37) {
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 134, 37) {
