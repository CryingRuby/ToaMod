...
public class ToamodModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITIES, ToamodMod.MODID);
	public static final RegistryObject<EntityType<HorseCareTakerEntity>> HORSE_CARE_TAKER = register("horse_care_taker",
			EntityType.Builder.<HorseCareTakerEntity>of(HorseCareTakerEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true)
