...
public class ToamodModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> CREATURE_BARRIER = register("creature_barrier", ToamodModBlocks.CREATURE_BARRIER,
			CreatureBarrierBlockEntity::new);
	public static final RegistryObject<BlockEntityType<?>> SOUND_AREA_SWITCH = register("sound_area_switch", ToamodModBlocks.SOUND_AREA_SWITCH,
			SoundAreaSwitchBlockEntity::new);
