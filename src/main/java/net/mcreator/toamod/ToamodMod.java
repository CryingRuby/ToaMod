...
@Mod("toamod")
public class ToamodMod {
	public static final Logger LOGGER = LogManager.getLogger(ToamodMod.class);
	public static final String MODID = "toamod";
	...
	public ToamodMod() {
		...
		ToamodModTabs.REGISTRY.register(bus);

		ToamodModMobEffects.REGISTRY.register(bus);

		ToamodModMenus.REGISTRY.register(bus);
