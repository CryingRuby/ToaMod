...
public class ProtectionEnchantment extends ToaEnchantment {
	...
	public String getDescription(int level) {
		return "§7Increases §fArmor §7by §c" + ToaFormats.floatToString(stats.AR[level - 1]) + "§7.";
	}

	@Override
	public ToaEnchantment[] getIncompatibleEnchants() {
		return new ToaEnchantment[]{(ToaEnchantment) ToamodModEnchantments.MAGIC_PROTECTION.get()};
	}
}
